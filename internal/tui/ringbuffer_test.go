...
func TestRingBuffer_NewRingBuffer_NormalCapacity(t *testing.T) {
...
func TestRingBuffer_NewRingBuffer_ZeroCapacityBecomesOne(t *testing.T) {
...
func TestRingBuffer_NewRingBuffer_NegativeCapacityBecomesOne(t *testing.T) {
...
func TestRingBuffer_Items_EmptyBufferReturnsNil(t *testing.T) {
	rb := NewRingBuffer[int](3)

	assert.Nil(t, rb.Items())
}

func TestRingBuffer_Items_NotFullBufferReturnsItemsInOrder(t *testing.T) {
	rb := NewRingBuffer[int](5)
	rb.Push(1)
	rb.Push(2)
	rb.Push(3)
...
func TestRingBuffer_Items_FullBufferWithOverflowReturnsItemsInCorrectOrder(t *testing.T) {
	rb := NewRingBuffer[int](3)
	rb.Push(1)
	rb.Push(2)
	rb.Push(3)
